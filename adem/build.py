...
import json
from adem import ModelArgs, Tokenizer, Transformer
from adem.adapter import set_Llama_Adapter, set_Clip_Adapter
...
def create_model(args):
    ...
    if len(model_args.down_sample_num) == 1:
        model_args.down_sample_num = model_args.down_sample_num[0]
    model_args.with_cls = not args.no_cls
    ...
    set_Llama_Adapter(llama, s=args.alpha, gradient_checkpointing=args.gradient_checkpointing, drop_ratio=args.drop_ratio)
